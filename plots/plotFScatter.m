...
scatter3(nonzero_points(:,1), nonzero_points(:,2), nonzero_points(:,3), 'filled', 'MarkerEdgeColor', 'none', 'CData', vecnorm(nonzero_pressures, 2, 2), 'SizeData', 100*abs(vecnorm(nonzero_pressures, 2, 2))); %250*abs(vecnorm(nonzero_pressures, 2, 2))
colormap(jet);
